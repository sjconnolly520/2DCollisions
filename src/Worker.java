...
public class Worker extends Thread {
	...
	public Worker(int ID, BodyCollector bodies, Point2D[][] forces) {
		this.ID = ID;
...
//			TODO figure out if this loop should go from i..n
			for(int j = i+1; j< bodies.size(); j++){
				...
				MassiveBody first = bodies.get(startBody);
				MassiveBody second = bodies.get(endBody);
    ...
    //              NOTE Bree has no idea how to make this look nicer
                    double v1fx = (((second.getxVel() * (second.getxPos() - first.getxPos()) * (second.getxPos() - 
                            first.getxPos())) + (second.getyVel() * (second.getxPos() - first.getxPos()) *
                            (second.getyPos() - first.getyPos()))) + ((first.getxVel() * (second.getyPos() -
                            first.getyPos()) * (second.getyPos() - first.getyPos())) - (first.getyVel() *
                    ...
                    double v1fy = (((second.getxVel() * ((second.getxPos() - first.getxPos()) * (second.getyPos() - 
                            first.getyPos())) + (second.getyVel() * (second.getyPos() - first.getyPos()) * 
                            (second.getyPos() - first.getyPos())))) - ((first.getxVel() * (second.getyPos() -
                            first.getyPos()) * (second.getxPos() - first.getxPos())) + (first.getyVel() *
                            (second.getxPos() - first.getxPos()) * (second.getxPos() - first.getxPos())))) / 
                            (((second.getxPos() - first.getxPos()) * (second.getxPos() - first.getxPos())) +
                            ((second.getyPos() - first.getyPos()) * (second.getyPos() - first.getyPos())));
                    
    //              compute x- and y-velocities for second body after collision
                    double v2fx = (((first.getxVel() * ((second.getxPos() - first.getxPos()) * (second.getxPos() - 
                            first.getxPos())) + (first.getyVel() * (second.getxPos() - first.getxPos()) * 
                            (second.getyPos() - first.getyPos())))) + ((second.getxVel() * (second.getyPos() -
                            first.getyPos()) * (second.getyPos() - first.getyPos())) - (second.getyVel() *
                            (second.getxPos() - first.getxPos()) * (second.getyPos() - first.getyPos())))) / 
                            (((second.getxPos() - first.getxPos()) * (second.getxPos() - first.getxPos())) +
                            ((second.getyPos() - first.getyPos()) * (second.getyPos() - first.getyPos())));
    
                    double v2fy = (((first.getxVel() * ((second.getxPos() - first.getxPos()) * (second.getyPos() - 
                            first.getyPos())) + (first.getyVel() * (second.getyPos() - first.getyPos()) * 
                            (second.getyPos() - first.getyPos())))) - ((second.getxVel() * (second.getyPos() -
                            first.getyPos()) * (second.getxPos() - first.getxPos())) + (second.getyVel() *
                            (second.getxPos() - first.getxPos()) * (second.getxPos() - first.getxPos())))) / 
                            (((second.getxPos() - first.getxPos()) * (second.getxPos() - first.getxPos())) +
                            ((second.getyPos() - first.getyPos()) * (second.getyPos() - first.getyPos())));
...
//				first.setXForce(first.getXForce() + gravForceMag*directionX/distance);
//				second.setXForce(second.getXForce() - gravForceMag*directionX/distance);
//				first.setYForce(first.getYForce() + gravForceMag*directionY/distance);
//				second.setYForce(second.getYForce() - gravForceMag*directionY/distance);
...
//				update force for second body
	...
	public double calculateDistance(MassiveBody first, MassiveBody other) {
		return Math.sqrt(((first.getxPos() - other.getxPos()) * (first.getxPos() - other.getxPos())) + ((first.getyPos() - other.getyPos()) * (first.getyPos() - other.getyPos())));
	}
...
//        set body's position
            bodies.get(i).setxPos(bodies.get(i).getxPos() + xDeltaP);
            bodies.get(i).setyPos(bodies.get(i).getyPos() + yDeltaP);
//            
